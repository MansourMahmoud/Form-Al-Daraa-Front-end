...
const Footer = () => {
  ...
  return (
    <div className="px-2 dark-bg-900 dark-text flex flex-col gap-2 items-center justify-center flex-wrap text-center min-h-[25vh] bg-[#498ab4] shadow-2xl shadow-gary-900">
      <p className="text-darkMode-dark50 mt-10 sm:mt-0">
        بيع الأجهزة الإلكترونية والكهربائية بالتجزئة، وصيانتها، وحماية الشاشات
        من الكسر، واشتراكات في القنوات الدينية والرياضية.{" "}
      </p>
      <p className="text-darkMode-dark50">
